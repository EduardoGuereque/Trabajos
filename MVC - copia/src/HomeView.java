...
public class HomeView {
	...
	private ProductController productoController = new ProductController();
	...
	private void initialize() {
		...
		JButton Btnusuarios = new JButton("Users");
		Btnusuarios.setBounds(10, 11, 110, 53);
		panel_1_1.add(Btnusuarios);
		...
		JButton Btnagregar = new JButton("Products");
		Btnagregar.setBounds(158, 11, 110, 53);
		...
		Btnagregar.setIcon(new ImageIcon(HomeView.class.getResource("/Recursos/agregar-producto.png")));
		
		JButton Btnajustes = new JButton("");
		Btnajustes.setBounds(304, 11, 110, 53);
		panel_1_1.add(Btnajustes);
